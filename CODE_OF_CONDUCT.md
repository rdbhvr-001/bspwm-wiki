...
1. **Correction**  
   A private, written warning explaining the violation.

2. **Warning**  
   A formal warning with consequences for continued behavior.

3. **Temporary Ban**  
   Temporary removal from project participation.
